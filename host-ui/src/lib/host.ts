...
export const SHARE_MODE_OPTIONS = [
  {
    id: 'mirror',
    label: '镜像主屏（按平板分辨率）',
    hint: '镜像电脑主屏并按平板分辨率输出。免驱动；「跟随平板」时会临时切电脑分辨率。锁屏后无法抓屏。',
  },
  {
    id: 'extend',
    label: '双屏扩展（电脑屏仍亮）',
    hint: '平板作为独立桌面（类似 GlideX）。虚拟屏 1:1 抓取，电脑屏继续亮。适合坐在电脑前。',
  },
  {
    id: 'external',
    label: '仅平板（电脑屏关闭·躺着用）',
    hint: '虚拟屏 1:1 铺满平板，平板连上后关掉电脑屏。投屏期间防休眠；合盖请设为不采取任何操作。不要锁屏。',
  },
] as const
