...
**当前版本：[v0.1.72](https://github.com/a3165458/lighting/releases/tag/v0.1.72)**（仅平板关断和双屏扩展结束时都保留虚拟屏）
...
| 文件 | 说明 |
|------|------|
| `Lighting-0.1.72-setup.exe` | 安装包（推荐） |
| `Lighting-0.1.72-portable.exe` | 便携版，不用安装 |
...
2. 安装 `Lighting-0.1.72-setup.exe`，或打开便携包
