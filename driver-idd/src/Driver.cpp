...
void IndirectDeviceContext::InitAdapter()
{
    ...
    AdapterCaps.EndPointDiagnostics.pEndPointFriendlyName = L"Lighting Virtual Display";
    AdapterCaps.EndPointDiagnostics.pEndPointManufacturerName = L"Lighting";
    AdapterCaps.EndPointDiagnostics.pEndPointModelName = L"LightingIdd";
